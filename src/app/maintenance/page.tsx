    ...
    <div className='mt-8 space-y-4'>
      ...
      <div className='bg-card rounded-lg p-4 border'>
        ...
        <div className='text-muted-foreground mb-2 font-mono text-xs'>
          SELECT * FROM maintenance ORDER BY created_at DESC LIMIT 50;
        </div>
        
        {error ? (
          <div className='text-destructive bg-destructive/10 p-3 rounded border border-destructive/20'>Error: {error}</div>
        ) : tableData.length === 0 ? (
          <div className='text-warning bg-warning/10 p-3 rounded border border-warning/20'>No records found in maintenance table</div>
        ) : (
...
export const metadata = {
  title: 'Annual Maintenance Checklist - FormScaffold Demo',
  description: 'Auto-generated form demo page for maintenance table',
};
